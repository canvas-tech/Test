...
WebUI.setText(findTestObject('New_Test_Create_View/Page_Canvas World/enter_ViewId'), findTestData('Grid_id').getValue('Grp_Multi', 
        1))
...
WebUI.selectOptionByValue(findTestObject('New_Test_Create_View/Page_Canvas World/select_ViewType'), 'ADVGROUP', false)
...
String selectForm = ('//span[starts-with(text(), \'' + 'ACCOUNT_TABLE') + '\')]'
...
WebUI.click(findTestObject('New_Test_Create_List_Grid/Page_Canvas World/button_more'))

WebUI.click(findTestObject('New_Test_Create_List_Grid/Page_Canvas World/is_grpable'))

WebUI.click(findTestObject('New_Test_Create_List_Grid/Page_Canvas World/is_grpd'))

WebUI.delay(1)

WebUI.selectOptionByValue(findTestObject('New_Test_Create_List_Grid/Page_Canvas World/aggregate_using'), findTestData('Test Data').getValue(
        'Grp_using', 1), false)

WebUI.delay(1)

WebUI.click(findTestObject('New_Test_Create_List_Grid/Page_Canvas World/view_item_submit'))

WebUI.delay(3)

WebUI.click(findTestObject('New_Test_Create_List_Grid/Page_Canvas World/currency_more'))
