...
WebUI.setText(findTestObject('New_Test_Create_Request Moduler/Page_Canvas World/input_tableName_contains'), findTestData(
        'Req_Mod_Test Data').getValue('Table_Name', 3))

WebUI.click(findTestObject('New_Test_Create_Request Moduler/Page_Canvas World/table_search'))

WebUI.delay(4)

String resultTable = ('(//span[contains(text(),\'' + findTestData('Req_Mod_Test Data').getValue('Table_Name', 3)) + '\')])[1]'
...
WebUI.click(findTestObject('Req_Mod_Demo/select_Form_Def'))

String selectForm = ('(//span[contains(text(),\'' + req_id) + '_FORM\')])[1]'

println(selectReqWS)

TestObject edit = new TestObject(selectForm).addProperty('xpath', com.kms.katalon.core.testobject.ConditionType.EQUALS, 
    selectForm, true)

WebUI.waitForElementVisible(edit, 3)

WebUI.rightClick(edit)

WebUI.delay(2)

WebUI.click(findTestObject('Req_Mod_Demo/edit_form'))

WebUI.delay(4)

WebUI.click(findTestObject('Req_Mod_Demo/delete_subMenu'))

WebUI.delay(2)

WebUI.click(findTestObject('Req_Mod_Demo/click_ok'))

WebUI.delay(2)

WebUI.click(findTestObject('Req_Mod_Demo/delete_form'))

not_run: WebUI.delay(2)

not_run: WebUI.click(findTestObject('Req_Mod_Demo/click_ok'))

WebUI.delay(2)

WebUI.click(findTestObject('Req_Mod_Demo/click_Form_Wiz'))

WebUI.delay(2)

WebUI.click(findTestObject('Req_Mod_Demo/select_Login_Form'))

WebUI.click(findTestObject('Req_Mod_Demo/select_Pers_detail'))

WebUI.click(findTestObject('Req_Mod_Demo/select_Bank_details'))

WebUI.delay(2)

WebUI.click(findTestObject('Req_Mod_Demo/save_Wiz'))

WebUI.delay(6)

WebUI.click(findTestObject('Req_Mod_Demo/step_click'))

WebUI.delay(3)

WebUI.click(findTestObject('Req_Mod_Demo/back_nav'))

WebUI.delay(3)

WebUI.click(findTestObject('Req_Mod_Demo/fwd_Nav'))

WebUI.delay(3)

WebUI.click(findTestObject('Req_Mod_Demo/newForm_save'))
