...
WebUI.setText(findTestObject('New_Test_Create_View/Page_Canvas World/enter_ViewId'), findTestData('Grid_id').getValue('Grp_Single', 
        1))
...
WebUI.selectOptionByValue(findTestObject('New_Test_Create_View/Page_Canvas World/select_ViewType'), 'GROUP', false)
