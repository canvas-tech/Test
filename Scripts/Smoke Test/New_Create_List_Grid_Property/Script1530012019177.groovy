...
WebUI.setText(findTestObject('New_Test_Create_View/Page_Canvas World/enter_ViewId'), findTestData('Grid_id').getValue('Property', 
        1))
...
WebUI.selectOptionByValue(findTestObject('New_Test_Create_View/Page_Canvas World/select_ViewType'), 'PROPERTY', false)
