...
WebUI.selectOptionByValue(findTestObject('New_Test_Create_View/Page_Canvas World/select_ViewType'), 'ORG', false)
...
WebUI.selectOptionByValue(findTestObject('Chart_type/org_chart_direction'), 'top-to-bottom', false)
