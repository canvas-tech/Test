...
WebUI.setText(findTestObject('New_Test_Create_View/Page_Canvas World/enter_ViewId'), view_id)

WebUI.click(findTestObject('New_Test_Create_View/Page_Canvas World/view_DisplayName'))

WebUI.setText(findTestObject('New_Test_Create_View/Page_Canvas World/view_DisplayName'), view_id)

WebUI.selectOptionByValue(findTestObject('New_Test_Create_View/Page_Canvas World/select_ViewType'), 'FORM', false)
...
WebUI.click(findTestObject('New_Test_Create_View/Page_Canvas World/click_selectForm'))

String selectForm = ('//span[starts-with(text(), \'' + form_id) + '\')]'
...
//WebUI.setText(findTestObject('New_Test_Create_View/Page_Canvas World/enter_form_DataSource'), form_id)
