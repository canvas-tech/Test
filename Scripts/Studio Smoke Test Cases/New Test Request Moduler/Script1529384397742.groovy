...
String selectDB = ('//span[starts-with(text(), \'' + findTestData('Req_Mod_Test Data').getValue('DB_Name', 1)) + '\')]'
...
WebUI.click(findTestObject('New_Test_Create_Request Moduler/Page_Canvas World/enter_tableName'))
...
WebUI.sendKeys(findTestObject('Create Request Modeler/Page_Canvas World/SummaryColumn'), 'ACCOUNT_NO', FailureHandling.STOP_ON_FAILURE)
...
WebUI.sendKeys(findTestObject('New_Test_Create_Request Moduler/Page_Canvas World/business_key'), 'ACCOUNT_NO', FailureHandling.STOP_ON_FAILURE)
...
String selectReqWS = ('//span[contains(text(),\'' + findTestData('Req_Mod_Test Data').getValue('Req_Mod_WS', 1)) + '\')]'
